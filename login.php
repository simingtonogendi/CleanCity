        ...
        <div class="sign_up">
            <div class="row">
                ...
                <div class="right">
                    ...
                    <h3 class="text-danger">Access your account here</h3>
                    <hr class="mb-lg-4">
                    <form class="frm" action="authentication.php" method="POST">
                        ...
                        <hr class="mb-lg-4">
                        <button type="submit" name="btn_register" class="btn btn-primary">Login</button>
                    </form>
                </div>
